...
const fptPrepStorageKey = 'fpt-ai-test-prep-progress-v6'
...
const initialFptPrepPlan = [
  {
    id: 'coding',
    title: 'LeetCode',
    target: 'Lộ trình 30 ngày: mỗi bài đều ghi brute force, tối ưu, độ phức tạp, lỗi mắc và dấu hiệu nhận diện pattern.',
    days: [
      {
        id: 'lc-week-1',
        day: 'Tuần 1',
        time: 'Ngày 1 - 7',
        focus: 'Array, String, HashMap, Prefix Sum, Two Pointers, Sliding Window',
        learned: 'Quen cách biến đề thành cấu trúc dữ liệu, nghĩ brute force trước rồi tối ưu bằng dict/set/prefix/window.',
      ...
      },
      {
        ...
        day: 'Tuần 2',
        time: 'Ngày 8 - 14',
        focus: 'Stack, Queue, Binary Search, Linked List',
        learned: 'Nhận diện pattern nhanh hơn, viết pointer/binary search không kẹt loop, xử lý null và edge case chắc.',
      ...
      },
      {
        ...
        day: 'Tuần 3',
        time: 'Ngày 15 - 21',
        focus: 'Tree, Graph, Recursion, Backtracking',
        learned: 'Luyện tư duy đệ quy, BFS/DFS và duyệt trạng thái có visited/checkpoint rõ ràng.',
      ...
      },
      {
        ...
        day: 'Tuần 4',
        time: 'Ngày 22 - 30',
        focus: 'Dynamic Programming, Greedy, Heap, Mock Interview',
        learned: 'Biết xác định state/base/transition, chọn greedy khi có lựa chọn cục bộ hợp lý, và giải thích solution như phỏng vấn.',
        tasks: buildTaskList('lc-p4', [
          ...
          'Ngày 30: Tổng kết pattern - HashMap, Two Pointers, Sliding Window, Stack, Binary Search, Tree, Graph, Backtracking, DP, Greedy, Heap',
          'Mỗi bài trong sổ tay: tên bài, dấu hiệu nhận diện, brute force, tối ưu, độ phức tạp, lỗi mắc, câu chốt nhớ lâu',
          'Khi bí dùng 20-10-30: 20 phút tự nghĩ, 10 phút xem hint, 30 phút tự code lại không nhìn đáp án',
        ]),
      },
    ],
  },
